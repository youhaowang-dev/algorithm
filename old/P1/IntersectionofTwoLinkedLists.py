...
# Airbnb 3 Bloomberg 2 Apple 2 Microsoft 9 Amazon 8 LinkedIn 4 TikTok 4 Facebook 3 Adobe 3 Nvidia 3 Oracle 2
# ByteDance 3 Intuit 3 Qualcomm 2 Uber 2 Google 2 Goldman Sachs 2 Samsung 2 Spotify 2 Nutanix 2
...
# get lengths and move two pointers to the same end-start index, then move together
class IntersectionofTwoLinkedLists:
    def getIntersectionNode(
        ...
        list1_pointer = head1
        list2_pointer = head2
        for _ in range(abs(list1_length - list2_length)):
